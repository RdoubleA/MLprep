...
![](https://latex.codecogs.com/gif.latex?\mathbf{R}_t&space;=&space;\sigma(\mathbf{X}_t&space;\mathbf{W}_{xr}&space;&plus;&space;\mathbf{H}_{t-1}&space;\mathbf{W}_{hr}&space;&plus;&space;\mathbf{b}_r)\\&space;\indent\mathbf{Z}_t&space;=&space;\sigma(\mathbf{X}_t&space;\mathbf{W}_{xz}&space;&plus;&space;\mathbf{H}_{t-1}&space;\mathbf{W}_{hz}&space;&plus;&space;\mathbf{b}_z)\\&space;\indent\tilde{\mathbf{H}}_t&space;=&space;\tanh(\mathbf{X}_t&space;\mathbf{W}_{xh}&space;&plus;&space;\left(\mathbf{R}_t&space;\odot&space;\mathbf{H}_{t-1}\right)&space;\mathbf{W}_{hh}&space;&plus;&space;\mathbf{b}_h)\\&space;\indent\mathbf{H}_t&space;=&space;\mathbf{Z}_t&space;\odot&space;\mathbf{H}_{t-1}&space;&plus;&space;(1&space;-&space;\mathbf{Z}_t)&space;\odot&space;\tilde{\mathbf{H}}_t)
